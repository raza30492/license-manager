...
INSERT INTO users (id, created_at, created_by, enabled, modified_at, modified_by, account_expired, account_locked, credential_expired, email, mobile, first_name, last_name, otp, otp_sent_at, password, retry_count, roles, username) VALUES
...
INSERT INTO product (id, created_at, created_by, enabled, modified_at, modified_by, description, name, product_prefix, flavours) VALUES
(1,'2017-07-03 02:43:07','Md Zahid Raza',true,'2017-07-03 02:43:07','Md Zahid Raza','A Timeline Tracking Software for Apparrel Industories','Time And Action Calender','TNA','EXPRESS,PREMIUM,ULTIMATE'),
(2,'2017-07-03 02:43:07','Md Zahid Raza',true,'2017-07-03 02:43:07','Md Zahid Raza','A Issue Tracking Software','Andon System','ANDON','EXPRESS,PREMIUM');
--
